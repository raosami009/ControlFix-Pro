function Logo({ className = "h-8 w-auto" }) {
  return (
    <svg width="200" height="40" viewBox="0 0 200 40" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <text x="40" y="27" fontFamily="Orbitron, sans-serif" fontWeight="700" fontSize="20" letterSpacing="0.5" fill="#ffffff">
        ControllerFix <tspan fill="url(#logoGradient)">Pro</tspan>
      </text>
    </svg>
  )
}
