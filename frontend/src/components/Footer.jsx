  ...
  return (
    <footer className="border-t border-[#434655] bg-[#0c1322] px-6 py-12 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-4">
        <div className="space-y-4 md:col-span-1">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#2563eb]/20 text-xl">
              🎮
            </div>
            <div>
              <p className="text-lg font-semibold text-[#f9fafb]">ControlFix Pro</p>
          ...
          <div className="flex gap-3 text-[#b4c5ff]">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2 text-sm text-[#c3c6d7]">
            ...
            <p>[PLACEHOLDER — Mississauga address]</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2 text-sm text-[#c3c6d7]">
            <p className="flex justify-between"><span>Mon - Fri</span><span>[PLACEHOLDER]</span></p>
            <p className="flex justify-between"><span>Saturday</span><span>[PLACEHOLDER]</span></p>
      ...
      <div className="mx-auto mt-10 flex max-w-7xl flex-col gap-3 border-t border-[#434655] pt-6 text-sm text-[#8f95a8] md:flex-row md:items-center md:justify-between">
        <p>© 2026 ControlFix Pro. Technical Precision Guaranteed.</p>
        <div className="flex flex-wrap gap-4">
          <a href="#home" className="transition hover:text-[#f9fafb]">Privacy Policy</a>
          <a href="#services" className="transition hover:text-[#f9fafb]">Terms of Service</a>
          <a href="#process" className="transition hover:text-[#f9fafb]">Warranty Info</a>
          <a href="#contact" className="transition hover:text-[#f9fafb]">Sitemap</a>
        </div>
      </div>
    </footer>
  )
